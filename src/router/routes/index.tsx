...
export const baseRoutes: AppRoute[] = [
  ...
  },
  {
    ...
    children: [
      { path: "active-evaluation", id: "active-evaluation", meta: { title: "Evaluasi Aktif" } },
      { path: "approval-evaluation", id: "approval-evaluation", meta: { title: "Approval Evaluasi", hideInSidebar: false } },
    ],
  },
  {
    path: "gallery",
